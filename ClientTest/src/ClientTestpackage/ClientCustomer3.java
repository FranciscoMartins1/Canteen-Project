...
public class ClientCustomer3 extends Application {
    ...
    private void openCustomerPage(Stage primaryStage) {
        ...
        placeOrderButton.setOnAction(e -> showInfo("Place Order", "Implement the logic for placing an order"));
    ...
    private void showOrdersPage(Stage primaryStage) {
        ...
        Scene ordersScene = new Scene(ordersTableView, 600, 400);
