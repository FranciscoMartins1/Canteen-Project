...
public class ClientOrder4 extends Application {
    ...
    private void fillTableView(TableView<MaOrder> tableView) {
        ...
        List<MaOrder> menus = getMaOrder();
        for (MaOrder ord : menus) {
    ...
    private List<MaOrder> getMaOrder() {
        Gson gson = new Gson();

        String responseAdminsList = service.path("getMaOrders").request(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON).get(String.class);

        List<MaOrder> maOrder = Arrays.asList(gson.fromJson(responseAdminsList, MaOrder[].class));
    ...
    private List<MenuOptions> getMenuOptions() {
        ...
        String responseAdminsList = serviceMenu.path("getMenuOptions").request(MediaType.APPLICATION_JSON)
                .accept(MediaType.APPLICATION_JSON).get(String.class);
